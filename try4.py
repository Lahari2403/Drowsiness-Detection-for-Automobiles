...
# Email Configuration
SENDER_EMAIL = os.getenv("ajithkumarreddy04@gmail.com")  # Sender's email
EMAIL_PASSWORD = os.getenv("12345678")  # Sender's app password
RECEIVER_SMS = "9343241003@smsgateway.com"  # Replace with the recipient's SMS gateway
