...
EAR_THRESHOLD = 0.25
MAR_THRESHOLD = 0.7
DETECTION_DURATION = 3  # Time in seconds for EAR to be below threshold
...
start_time = None  # Timer for drowsiness detection
drowsiness_count = 0
yawn_count = 0
...
while True:
    ...
    for face in faces:
        ...
        if ear < EAR_THRESHOLD:
            ...
            start_time = None  # Reset timer if EAR is above threshold
