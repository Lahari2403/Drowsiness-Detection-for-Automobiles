...
parser.add_argument("-p", "--shape_predictor", required=True, help="Path to facial landmark predictor model")
parser.add_argument("-r", "--raspberry", type=bool, default=False, help="Use Raspberry Pi camera")
...
# Initialize the video stream and dataset directory
assure_path_exists(DATASET_DIR)
cap = cv2.VideoCapture(0 if not args.raspberry else "YOUR_PI_CAMERA_INDEX")
...
while True:
    ...
    for face in faces:
        ...
        if mar > MAR_THRESHOLD:
            ...
            pygame.mixer.music.load("yawn.wav")  # Replace with your file path
            pygame.mixer.music.play()
