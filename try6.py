...
def send_email_alert(subject, body):
    ...
    if not all([SENDER_EMAIL, EMAIL_PASSWORD, RECEIVER_EMAIL]):
        print("[ERROR] Missing email credentials or receiver email address.")
        return
    ...
    for face in faces:
        ...
        if ear < EAR_THRESHOLD:
            ...
            if frame_count >= CONSEC_FRAMES:
                ...
                send_email_alert("Drowsiness Alert", "Drowsiness detected! Please take a break.")
        ...
        if mar > MAR_THRESHOLD:
            ...
            pygame.mixer.music.play()
            send_email_alert("Yawning Alert", "Yawning detected! Please stay alert.")
