...
def send_sms_alert():
    sender_email = "laharilavakumar@gmail.com"  # Your Gmail email address
    receiver_sms = "9343241003@smsgateway.com"  # Recipient's email-to-SMS gateway address
    password = "lavalahari"  # Your email password or use an App Password
